            ...
            <div class="w-full max-w-md rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-dark-800" @click.stop>
                ...
                <form method="post" action="{{ route('profile.destroy') }}" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input id="password" name="password" type="password" placeholder="{{ __('Enter your password') }}" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-gray-900 placeholder-gray-500 outline-none transition focus:border-red-600 focus:ring-2 focus:ring-red-100 dark:border-gray-600 dark:bg-dark-800 dark:text-white dark:placeholder-gray-400 dark:focus:border-red-600 dark:focus:ring-red-900/20" />
