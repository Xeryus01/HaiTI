                ...
                <div class="flex items-center space-x-2 sm:space-x-4">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="bg-brand-600 text-white px-3 sm:px-4 py-2 rounded-md text-sm font-medium hover:bg-brand-700">
                                Daftar
                            </a>
                        @endif
                    @endauth
            ...
            <div class="text-center">
                ...
                <div class="mt-8 pt-6 border-t border-white/20 max-w-3xl mx-auto">
                    ...
                    <div class="flex flex-col sm:flex-row items-center gap-3 sm:gap-4">
                        @foreach($currentData['piket'] as $lokasi => $nama)
                            <?php 
                            ...
                            <div class="group relative flex-1 sm:flex-none">
                                <div class="absolute inset-0 bg-gradient-to-r {{ $colors['accent'] }} rounded-lg blur opacity-20 group-hover:opacity-40 transition-all duration-300"></div>
                                <div class="relative bg-white/5 backdrop-blur-sm border border-white/20 rounded-lg px-4 py-3 hover:border-white/40 hover:bg-white/10 transition-all duration-300 w-full sm:w-auto">
                                    <div class="flex flex-col items-center gap-1.5">
                                        ...
                                        <p class="text-xs sm:text-sm font-semibold text-gray-300">{{ $displayLocation }}</p>
                                        <p class="text-xs sm:text-sm font-bold text-white">{{ $nama }}</p>
                                    </div>
                                </div>
                            </div>
                            @if(!$loop->last)
    ...
    <section class="py-12 sm:py-16 lg:py-20 bg-brand-600 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2">
                @auth
                    <a href="{{ route('tickets.create') }}" class="bg-white text-brand-600 px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-sm sm:text-base">Ajukan Tiket Sekarang</a>
                @else
                    <a href="{{ route('register') }}" class="bg-white text-brand-600 px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-sm sm:text-base">Daftar Akun</a>
                    <a href="{{ route('login') }}" class="border-2 border-white text-white px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:bg-white hover:text-brand-600 transition-colors text-sm sm:text-base">Masuk</a>
                @endauth
            </div>
        </div>
    </section>
