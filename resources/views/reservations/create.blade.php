...
<div class="ml-64 min-h-screen">
    <div class="p-5 sm:p-7.5 lg:p-9">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white sm:text-3xl">New Reservation</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Create a new room reservation</p>
        </div>
        ...
        <div class="max-w-2xl rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-dark-800 sm:p-8">
            ...
            <form method="POST" action="{{ route('reservations.store') }}" class="space-y-6" id="reservationForm">
                ...
                <div>
                    ...
                    <input id="room_name" type="text" name="room_name" value="{{ old('room_name') }}" required placeholder="e.g., Conference Room A" class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-gray-900 placeholder-gray-500 outline-none transition focus:border-brand-600 focus:ring-2 focus:ring-brand-100 disabled:cursor-default disabled:bg-gray-50 dark:border-gray-600 dark:bg-dark-800 dark:text-white dark:placeholder-gray-400 dark:focus:border-brand-600 dark:focus:ring-brand-900/20 @error('room_name') border-red-500 @enderror" />
                    @error('room_name')
                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <input id="start_time" type="datetime-local" name="start_time_local" required class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-gray-900 outline-none transition focus:border-brand-600 focus:ring-2 focus:ring-brand-100 disabled:cursor-default disabled:bg-gray-50 dark:border-gray-600 dark:bg-dark-800 dark:text-white dark:focus:border-brand-600 dark:focus:ring-brand-900/20 @error('start_time') border-red-500 @enderror" />
                    ...
                    <div>
                        ...
                        <input id="end_time" type="datetime-local" name="end_time_local" required class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-gray-900 outline-none transition focus:border-brand-600 focus:ring-2 focus:ring-brand-100 disabled:cursor-default disabled:bg-gray-50 dark:border-gray-600 dark:bg-dark-800 dark:text-white dark:focus:border-brand-600 dark:focus:ring-brand-900/20 @error('end_time') border-red-500 @enderror" />
