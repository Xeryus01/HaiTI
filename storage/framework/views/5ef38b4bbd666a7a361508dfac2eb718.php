    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-6">
        ...
        <div class="flex items-center justify-between">
            <?php if(Route::has('password.request')): ?>
                <a href="<?php echo e(route('password.request')); ?>" class="text-sm font-medium text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300">
        ...
        <div class="text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="<?php echo e(route('register')); ?>" class="font-medium text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300">
...
<?php endif; ?>
<?php /**PATH C:\Users\BPS 1900\Documents\HaiTI\resources\views/auth/login.blade.php ENDPATH**/ ?>