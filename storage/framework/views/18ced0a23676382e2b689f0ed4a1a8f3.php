        ...
        <div class="mb-6 flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">
                    You have <span class="font-medium"><?php echo e(auth()->user()->notifications()->where('is_read', false)->count()); ?></span> unread notifications
                </p>
            </div>
            <?php if(auth()->user()->notifications()->where('is_read', false)->exists()): ?>
                <form action="<?php echo e(route('api.notifications.markAllAsRead')); ?>" method="POST" class="inline">
                    <?php echo csrf_field(); ?>
            ...
            <?php if($notifications->count() > 0): ?>
                <div class="space-y-3">
                    <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-start gap-4 p-4 rounded-lg border border-gray-200 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-white/5 transition <?php echo e(!$notification->is_read ? 'bg-blue-50/50 dark:bg-blue-500/10' : ''); ?>">
                            <!-- Unread Indicator -->
                            <div class="mt-1">
