...
unset($__errorArgs, $__bag); ?>">
                        <option value="GOOD" <?php echo e(old('condition') === 'GOOD' ? 'selected' : ''); ?>>Baik</option>
                        <option value="FAIR" <?php echo e(old('condition') === 'FAIR' ? 'selected' : ''); ?>>Cukup</option>
                        <option value="POOR" <?php echo e(old('condition') === 'POOR' ? 'selected' : ''); ?>>Buruk</option>
                    </select>
