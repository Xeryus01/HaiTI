    ...
    <div class="p-5 sm:p-7.5 lg:p-9">
        ...
        <div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex flex-wrap gap-2">
                <a href="<?php echo e(url()->to(route('users.show', $user))); ?>" class="inline-flex items-center rounded-lg border border-gray-300 bg-white px-4 py-2 font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:bg-dark-800 dark:text-gray-300 dark:hover:bg-dark-700">
...
<?php endif; ?>
<?php /**PATH C:\Users\BPS 1900\Documents\timcare\resources\views\users\change-password.blade.php ENDPATH**/ ?>