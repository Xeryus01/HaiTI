        ...
        <div class="col-span-12 lg:col-span-8">
            <div class="rounded-sm border border-gray-200 bg-white shadow-md dark:border-gray-700 dark:bg-dark-800">
                            ...
                            <?php switch($notification->type):
                                ...
                                <?php case ('ticket_resolved'): ?>
                                    ...
                                    <div class="rounded-lg bg-gray-50 dark:bg-white/5 p-4">
                                        ...
                                        <a href="<?php echo e(url()->to(route('tickets.show', $ticket))); ?>" class="text-base font-medium text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300 mt-1">
                                ...
                                <?php case ('reservation_approved'): ?>
                                    ...
                                    <div class="rounded-lg bg-gray-50 dark:bg-white/5 p-4">
                                        ...
                                        <a href="<?php echo e(url()->to(route('reservations.show', $reservation))); ?>" class="text-base font-medium text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300 mt-1">
                                ...
                                <?php case ('asset_created'): ?>
                                    ...
                                    <div class="rounded-lg bg-gray-50 dark:bg-white/5 p-4">
                                        ...
                                        <a href="<?php echo e(url()->to(route('assets.show', $asset))); ?>" class="text-base font-medium text-brand-600 hover:text-brand-700 dark:text-brand-400 dark:hover:text-brand-300 mt-1">
                ...
                <div class="border-t border-gray-200 px-6.5 py-4 dark:border-gray-700 flex gap-2">
                    <a href="<?php echo e(url()->to(route('notifications.index'))); ?>" class="inline-flex items-center justify-center rounded-lg border border-gray-300 px-5 py-2.5 text-center font-medium text-gray-700 hover:bg-gray-2 dark:border-gray-600 dark:text-gray-400 dark:hover:bg-white/5">
                        Back to Notifications
                    </a>
                    <?php if(!$notification->is_read): ?>
                        <button onclick="fetch('<?php echo e(url('/api/notifications/' . $notification->id . '/mark-as-read')); ?>', {method: 'PATCH'}).then(r => location.reload())" class="inline-flex items-center justify-center rounded-lg bg-brand-600 px-5 py-2.5 text-center font-medium text-white hover:bg-brand-700">
                            Mark as Read
                        </button>
                    <?php endif; ?>
                    <button onclick="if(confirm('Delete this notification?')) fetch('<?php echo e(url('/api/notifications/' . $notification->id)); ?>', {method: 'DELETE'}).then(r => window.location.href = '<?php echo e(url('/notifications')); ?>')" class="inline-flex items-center justify-center rounded-lg border border-red-300 px-5 py-2.5 text-center font-medium text-red-600 hover:bg-red-50 dark:border-red-600/50 dark:text-red-400 dark:hover:bg-red-600/10">
                        Delete
                    </button>
                </div>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\BPS 1900\Documents\timcare\resources\views\notifications\show.blade.php ENDPATH**/ ?>