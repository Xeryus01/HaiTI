...
<div class="ml-64 min-h-screen">
    <div class="p-5 sm:p-7.5 lg:p-9">
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white sm:text-3xl">Add New Asset</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Register a new IT asset to the system</p>
        </div>
