        ...
        <div class="p-5 sm:p-7.5 lg:p-9">
            <div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                ...
                <?php if(auth()->user()->notifications()->where('is_read', false)->exists()): ?>
                    <button type="button" onclick="fetch('<?php echo e(url('/api/notifications/mark-all-as-read')); ?>', {method: 'PATCH'}).then(r => location.reload())" class="inline-flex items-center justify-center rounded-lg bg-brand-600 px-4 py-2 text-center font-medium text-white hover:bg-brand-700">
                        Tandai Semua Dibaca
                    </button>
                <?php endif; ?>
            </div>
