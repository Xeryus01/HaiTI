    ...
    <div class="mx-auto max-w-screen-xl px-4 py-5 sm:px-6 lg:px-8 lg:py-7">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between fade-in">
            <div>
                ...
                <p class="mt-0.5 text-sm text-slate-500 dark:text-slate-400">Halo, <span class="font-medium text-slate-700 dark:text-slate-200"><?php echo e(auth()->user()->name); ?></span>. Pantau tiket, Zoom, dan performa layanan.</p>
            </div>
            <div class="flex flex-wrap gap-2">
                <a href="<?php echo e(url()->to(route('tickets.create'))); ?>"
                ...
                <a href="<?php echo e(url()->to(route('reservations.create'))); ?>"
        ...
        <div class="mb-5 grid grid-cols-1 gap-3 sm:grid-cols-2 fade-in" style="animation-delay:.05s">
            ...
            ?>
            <?php $__currentLoopData = $topStats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="stat-card rounded-3xl border border-slate-200 bg-white p-3 shadow-sm transition-shadow hover:shadow-lg dark:border-slate-700 dark:bg-slate-900">
                <div class="flex items-center justify-between gap-3">
                    <div>
                        <p class="text-[10px] uppercase tracking-[0.28em] text-slate-500 dark:text-slate-400"><?php echo e($s['label']); ?></p>
                        <p class="mt-2 text-xl font-semibold text-slate-900 dark:text-white"><?php echo e($s['value']); ?></p>
                        <p class="mt-1 text-sm text-slate-500 dark:text-slate-400"><?php echo e($s['sub']); ?></p>
                    </div>
                    <span class="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-3xl <?php echo e($s['color']); ?>">
                        <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="<?php echo e($s['icon']); ?>"/></svg>
                    </span>
                </div>
            </div>
        ...
        <div class="mb-5 rounded-3xl border border-slate-200 bg-white p-4 shadow-sm transition-shadow hover:shadow-lg dark:border-slate-700 dark:bg-slate-900 fade-in" style="animation-delay:.1s">
            ...
            <div class="grid gap-3 sm:grid-cols-3">
                <div class="rounded-2xl bg-slate-50 p-3 dark:bg-slate-800/60">
                    ...
                    <p class="mt-2 text-xl font-semibold text-slate-900 dark:text-white"><?php echo e($openTicketCount); ?></p>
                ...
                <div class="rounded-2xl bg-slate-50 p-3 dark:bg-slate-800/60">
                    ...
                    <p class="mt-2 text-xl font-semibold text-slate-900 dark:text-white"><?php echo e($pendingZoomCount); ?></p>
                ...
                <div class="rounded-2xl bg-slate-50 p-3 dark:bg-slate-800/60">
                    ...
                    <p class="mt-2 text-xl font-semibold text-slate-900 dark:text-white"><?php echo e($totalServices); ?></p>
        ...
        <div class="mb-5 rounded-3xl border border-slate-200 bg-white p-3 shadow-sm transition-shadow hover:shadow-lg dark:border-slate-700 dark:bg-slate-900 fade-in" style="animation-delay:.12s">
            ...
            <div class="grid gap-2 grid-cols-2 xl:grid-cols-4">
                <?php $__currentLoopData = $zoomCalendarDays->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-50 to-white p-3 shadow-sm hover:shadow-md dark:border-slate-700 dark:from-slate-950 dark:to-slate-900">
                        <div class="flex items-start justify-between gap-2">
                            <div>
                                <p class="text-[10px] uppercase tracking-[0.28em] text-slate-500 dark:text-slate-400"><?php echo e($day['day_label']); ?></p>
                                <p class="mt-1 text-sm font-semibold text-slate-900 dark:text-white"><?php echo e($day['date_label']); ?></p>
                            </div>
                            <span class="rounded-full bg-slate-100 px-2 py-0.5 text-[10px] font-semibold text-slate-700 dark:bg-slate-800 dark:text-slate-300"><?php echo e($day['reservation_count']); ?>/4</span>
                        </div>
                                ...
                                <div class="space-y-2">
                                    <?php $__currentLoopData = $day['reservations']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reservation): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="rounded-2xl bg-white/90 px-2 py-2 shadow-sm dark:bg-slate-950/80">
                                            <p class="truncate font-semibold text-slate-900 dark:text-slate-100"><?php echo e($reservation['time']); ?></p>
                                            <p class="truncate text-slate-600 dark:text-slate-400"><?php echo e($reservation['label']); ?></p>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            <?php else: ?>
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-3 shadow-sm transition-shadow hover:shadow-lg dark:border-slate-700 dark:bg-slate-900">
                <div class="mb-3 flex items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="mt-1 text-xl font-semibold text-slate-900 dark:text-white"><?php echo e($ticketTotal); ?></p>
                    </div>
                ...
                <div class="space-y-2">
                    <?php $__currentLoopData = $ticketCounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $c = $ticketStatusColors[$label] ?? ['dot'=>'bg-slate-400','badge'=>'bg-slate-100 text-slate-600']; ?>
                    <div class="flex items-center justify-between rounded-2xl bg-slate-50 px-3 py-2 dark:bg-slate-800/60">
                        <div class="flex items-center gap-2 min-w-0">
                            <span class="badge-dot <?php echo e($c['dot']); ?>"></span>
                            <span class="truncate text-sm text-slate-600 dark:text-slate-300"><?php echo e($label); ?></span>
                        </div>
                        <span class="ml-2 flex-shrink-0 rounded-full <?php echo e($c['badge']); ?> px-2.5 py-1 text-sm font-semibold"><?php echo e($count); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-3 shadow-sm transition-shadow hover:shadow-lg dark:border-slate-700 dark:bg-slate-900">
                <div class="mb-3 flex items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="mt-1 text-xl font-semibold text-slate-900 dark:text-white"><?php echo e($zoomTotal); ?></p>
                    </div>
                ...
                <div class="space-y-2">
                    <?php $__currentLoopData = $zoomCounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $count): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php $c = $zoomStatusColors[$label] ?? ['dot'=>'bg-slate-400','badge'=>'bg-slate-100 text-slate-600']; ?>
                    <div class="flex items-center justify-between rounded-2xl bg-slate-50 px-3 py-2 dark:bg-slate-800/60">
                        <div class="flex items-center gap-2 min-w-0">
                            <span class="badge-dot <?php echo e($c['dot']); ?>"></span>
                            <span class="truncate text-sm text-slate-600 dark:text-slate-300"><?php echo e($label); ?></span>
            ...
            <div class="rounded-3xl border border-slate-200 bg-white p-3 shadow-sm transition-shadow hover:shadow-lg dark:border-slate-700 dark:bg-slate-900">
                <div class="mb-3 flex items-center justify-between gap-3">
                    <div>
                        ...
                        <p class="mt-1 text-xl font-semibold text-slate-900 dark:text-white"><?php echo e($layananSelesai); ?> <span class="text-sm font-normal text-slate-400">selesai</span></p>
                    </div>
                ...
                <div class="space-y-3">
                    <div class="rounded-2xl bg-slate-50 p-3 dark:bg-slate-800/60">
                        <div class="mb-2 flex items-center justify-between">
                            ...
                            <span class="text-sm font-bold text-emerald-600 dark:text-emerald-400"><?php echo e($serviceCompletionPercent); ?>%</span>
                        </div>
                        <div class="h-2.5 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700">
                            <div class="progress-bar h-2.5 rounded-full bg-gradient-to-r from-emerald-400 to-teal-500" style="width:<?php echo e($serviceCompletionPercent); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl bg-slate-50 p-3 dark:bg-slate-800/60">
                        <div class="mb-2 flex items-center justify-between">
                            ...
                            <span class="text-sm font-semibold text-indigo-600 dark:text-indigo-400"><?php echo e($ticketCompletionPercent); ?>%</span>
                        </div>
                        <div class="h-2.5 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700">
                            <div class="progress-bar h-2.5 rounded-full bg-gradient-to-r from-indigo-400 to-blue-500" style="width:<?php echo e($ticketCompletionPercent); ?>%"></div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-2xl bg-slate-50 p-3 dark:bg-slate-800/60">
                        <div class="mb-2 flex items-center justify-between">
                            ...
                            <span class="text-sm font-semibold text-violet-600 dark:text-violet-400"><?php echo e($zoomCompletionPercent); ?>%</span>
                        </div>
                        <div class="h-2.5 w-full overflow-hidden rounded-full bg-slate-200 dark:bg-slate-700">
                            <div class="progress-bar h-2.5 rounded-full bg-gradient-to-r from-violet-400 to-purple-500" style="width:<?php echo e($zoomCompletionPercent); ?>%"></div>
                        </div>
                    </div>
                </div>

                <p class="mt-3 text-xs text-slate-400 dark:text-slate-500">Total <?php echo e($totalServices); ?> layanan terdaftar.</p>
            </div>
        </div> -->
        ...
        <div class="mb-5 grid gap-3 lg:grid-cols-2 fade-in" style="animation-delay:.15s">
            <div class="chart-card rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
                <div class="mb-3 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(url()->to(route('exports.tickets'))); ?>"
            ...
            <div class="chart-card rounded-xl border border-slate-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-900">
                <div class="mb-3 flex items-center justify-between">
                    ...
                    <a href="<?php echo e(url()->to(route('exports.reservations'))); ?>"
                       class="inline-flex items-center gap-1 rounded-md border border-slate-200 bg-slate-50 px-2.5 py-1 text-sm font-medium text-slate-600 hover:bg-slate-100 transition-colors dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700">
                        <svg class="h-3 w-3" fill="none" stroke="currentColor" stroke-width="2.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
                        Ekspor CSV
                    </a>
        ...
        <div class="grid gap-3 lg:grid-cols-2 fade-in" style="animation-delay:.2s">
            ...
            <div class="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
                <div class="flex items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-slate-700">
                    ...
                    <a href="<?php echo e(route('tickets.index')); ?>" class="text-sm font-medium text-brand-600 hover:underline">Lihat semua</a>
                </div>
                <div class="scroll-thin max-h-72 divide-y divide-gray-200 overflow-y-auto dark:divide-slate-800">
                    ...
                    <div class="flex items-center gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800/60 transition-colors">
                        ...
                        <div class="min-w-0 flex-1">
                            <p class="truncate text-sm font-semibold text-slate-800 dark:text-white"><?php echo e($ticket->title); ?></p>
                            <p class="truncate text-xs text-slate-400"><?php echo e($ticket->code); ?> &bull; <?php echo e($ticket->category_label); ?></p>
                        </div>
                        <span class="flex-shrink-0 rounded-full bg-slate-100 px-2 py-0.5 text-xs font-medium text-slate-600 dark:bg-slate-800 dark:text-slate-300"><?php echo e($ticket->status_label); ?></span>
                    </div>
            ...
            <div class="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm dark:border-slate-700 dark:bg-slate-900">
                <div class="flex items-center justify-between border-b border-gray-200 px-4 py-3 dark:border-slate-700">
                    ...
                    <a href="<?php echo e(route('reservations.index')); ?>" class="text-sm font-medium text-brand-600 hover:underline">Lihat semua</a>
                </div>
                <div class="scroll-thin max-h-72 divide-y divide-gray-200 overflow-y-auto dark:divide-slate-800">
                    ...
                    <div class="flex items-center gap-3 px-4 py-3 hover:bg-slate-50 dark:hover:bg-slate-800/60 transition-colors">
                        ...
                        <div class="min-w-0 flex-1">
                            <p class="truncate text-sm font-semibold text-slate-800 dark:text-white"><?php echo e($reservation->room_name); ?></p>
                            <p class="truncate text-xs text-slate-400"><?php echo e(optional($reservation->start_time)->format('d/m/Y H:i')); ?> &bull; <?php echo e(\Illuminate\Support\Str::limit($reservation->purpose, 38)); ?></p>
                        </div>
                        <span class="flex-shrink-0 rounded-full bg-slate-100 px-2 py-0.5 text-xs font-medium text-slate-600 dark:bg-slate-800 dark:text-slate-300"><?php echo e($reservation->status_label); ?></span>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <div class="flex flex-col items-center justify-center py-8 text-center">
...
<?php endif; ?><?php /**PATH C:\Users\BPS 1900\Documents\timcare\resources\views/dashboard.blade.php ENDPATH**/ ?>