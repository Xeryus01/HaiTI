                ...
                <div class="grid gap-6 sm:grid-cols-2">
                    <div>
                        ...
                        <input id="start_time" type="datetime-local" name="start_time_local" required
                            ...
                            <?php endif; ?>
                            class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-gray-900 dark:border-gray-600 dark:bg-dark-800 dark:text-white <?php $__errorArgs = ['start_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
                    ...
                    <div>
                        ...
                        <input id="end_time" type="datetime-local" name="end_time_local" required
                            <?php if(!auth()->user()->hasRole('Admin')): ?>
                                min="<?php echo e(date('Y-m-d\TH:i')); ?>"
                            <?php endif; ?>
                            class="w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-gray-900 dark:border-gray-600 dark:bg-dark-800 dark:text-white <?php $__errorArgs = ['end_time'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
