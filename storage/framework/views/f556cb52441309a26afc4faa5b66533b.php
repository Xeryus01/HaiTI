...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <?php if($reservation->nota_dinas_path): ?>
                            <p class="mb-2 text-sm text-gray-600 dark:text-gray-400">Nota dinas saat ini: <a href="<?php echo e(route('reservations.nota-dinas', $reservation)); ?>" target="_blank" class="text-brand-600 hover:text-brand-700">Lihat PDF</a></p>
                        <?php endif; ?>
