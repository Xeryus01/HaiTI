...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex items-center justify-end">
                            <a href="<?php echo e(route('users.index')); ?>" class="mr-4 inline-flex items-center px-4 py-2 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-md font-semibold text-xs text-gray-700 dark:text-gray-300 uppercase tracking-widest shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-25 transition ease-in-out duration-150">
                                Batal
                            </a>
...
<?php endif; ?><?php /**PATH C:\Users\BPS 1900\Documents\HaiTI\resources\views/users/create.blade.php ENDPATH**/ ?>