...
<?php endif; ?>
                ...
                <div class="flex items-center space-x-2 sm:space-x-4">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="hidden sm:inline-block text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                            Masuk
                        </a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20 lg:py-24">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-2">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('tickets.create')); ?>" class="bg-white text-gray-900 px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-sm sm:text-base">
                            Ajukan Tiket Baru
                        </a>
                        <a href="<?php echo e(route('reservations.create')); ?>" class="border-2 border-white text-white px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-colors text-sm sm:text-base">
                            Ajukan Ruang Zoom
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>" class="bg-white text-gray-900 px-6 sm:px-8 py-2 sm:py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors text-sm sm:text-base">
                            Mulai Sekarang
                        </a>
