...
<?php endif; ?>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(url('/dashboard')); ?>" class="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                            Dashboard
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium">
                            Masuk
                        </a>
                        <?php if(Route::has('register')): ?>
                            <a href="<?php echo e(route('register')); ?>" class="bg-brand-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-brand-700">
                                Daftar
                            </a>
                        <?php endif; ?>
                    <?php endif; ?>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <?php if(auth()->guard()->check()): ?>
                        <a href="<?php echo e(route('tickets.create')); ?>" class="bg-white text-gray-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                            Ajukan Tiket Baru
                        </a>
                        <a href="<?php echo e(route('reservations.create')); ?>" class="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-gray-900 transition-colors">
                            Ajukan Ruang Zoom
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(route('register')); ?>" class="bg-white text-gray-900 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                            Mulai Sekarang
                        </a>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
                <div class="rounded-3xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-dark-800 p-6 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <div class="text-4xl font-semibold text-gray-900 dark:text-white mb-2"><?php echo e(\App\Models\Ticket::count()); ?></div>
                ...
                <div class="rounded-3xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-dark-800 p-6 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <div class="text-4xl font-semibold text-gray-900 dark:text-white mb-2"><?php echo e(\App\Models\Reservation::count()); ?></div>
                ...
                <div class="rounded-3xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-dark-800 p-6 shadow-sm hover:shadow-lg transition-shadow">
                    ...
                    <div class="text-4xl font-semibold text-gray-900 dark:text-white mb-2"><?php echo e(\App\Models\User::count()); ?></div>
    ...
    <section class="py-20 bg-brand-600 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('tickets.create')); ?>" class="bg-white text-brand-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">Ajukan Tiket Sekarang</a>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="bg-white text-brand-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">Daftar Akun</a>
                    <a href="<?php echo e(route('login')); ?>" class="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-brand-600 transition-colors">Masuk</a>
                <?php endif; ?>
            </div>
        </div>
    </section>
