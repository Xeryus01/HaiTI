            ...
            <div class="text-center mt-4">
                ...
                <div class="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center px-2 mb-8">
                    <?php if(auth()->guard()->check()): ?>
                        ...
                        <a href="<?php echo e(route('reservations.create')); ?>" class="border-2 border-white text-white px-8 sm:px-10 py-3 sm:py-4 rounded-lg font-bold hover:bg-white hover:text-gray-900 transition-colors text-base sm:text-lg">
                            Ajukan Ruang Zoom
                        </a>
                    <?php else: ?>
