...
<body class="h-full bg-gray-50 dark:bg-dark-900" x-data x-init="$store.theme.init()">
    ...
    <section class="py-20 bg-gray-50 dark:bg-dark-900">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="text-center">
                    <div class="text-4xl font-bold text-brand-600 mb-2"><?php echo e(\App\Models\Ticket::count()); ?></div>
                    <div class="text-gray-600 dark:text-gray-300">Tiket Ditangani</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl font-bold text-green-600 mb-2"><?php echo e(\App\Models\Reservation::count()); ?></div>
                    <div class="text-gray-600 dark:text-gray-300">Ruang Zoom Diajukan</div>
                </div>
                <div class="text-center">
                    <div class="text-4xl font-bold text-blue-600 mb-2"><?php echo e(\App\Models\User::count()); ?></div>
    ...
    <section class="py-20 bg-brand-600 text-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                <?php if(auth()->guard()->check()): ?>
                    <a href="<?php echo e(route('tickets.create')); ?>" class="bg-white text-brand-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                        Ajukan Tiket Sekarang
                    </a>
                <?php else: ?>
                    <a href="<?php echo e(route('register')); ?>" class="bg-white text-brand-600 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100 transition-colors">
                        Daftar Akun
                    </a>
                    <a href="<?php echo e(route('login')); ?>" class="border-2 border-white text-white px-8 py-3 rounded-lg font-semibold hover:bg-white hover:text-brand-600 transition-colors">
                        Masuk
                    </a>
                <?php endif; ?>
            </div>
            ...
            <div class="grid md:grid-cols-4 gap-8">
                <div class="col-span-2">
                    ...
                    <p class="text-sm text-gray-500">
                        © <?php echo e(date('Y')); ?> HaiTI. All rights reserved.
                    </p>
                </div>
                <div>
