...
<main class="p-6">
    <div class="max-w-2xl mx-auto">
                ...
                <div class="mb-8">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Perbarui informasi user <?php echo e($user->name); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-dark-800 overflow-hidden shadow-sm rounded-lg">
                    <form method="POST" action="<?php echo e(route('users.update', $user)); ?>" class="p-6">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <input id="phone_number" type="text" name="phone_number" value="<?php echo e(old('phone_number', $user->phone_number)); ?>"
                                   class="mt-1 block w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm placeholder-gray-400 dark:placeholder-gray-500 focus:outline-none focus:ring-brand-500 focus:border-brand-500 dark:bg-dark-700 dark:text-white">
...
<?php endif; ?><?php /**PATH C:\Users\BPS 1900\Documents\timcare\resources\views\users\edit.blade.php ENDPATH**/ ?>